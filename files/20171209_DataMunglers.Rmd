...
ggplot(pred_train, aes(x = Item_Weight, y = sqrt(Item_Outlet_Sales))) +
         geom_point() 
...
* Look at correlation with more visual way. ([https://cran.r-project.org](https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html)).
...
pred_simple <- predict(linear_model_simple,splitted_test)
summary(pred_simple)
pred_log <-10^predict(linear_model_log,splitted_test)
pred_sqrt <-predict(linear_model_sqrt,splitted_test)^2
# 
print("MAE of Simple")
MAE <- function(actual, predicted){mean(abs(actual - predicted))}
MAE(splitted_test$Item_Outlet_Sales, pred_simple)
print("MAE of Log")
(MAE(splitted_test$Item_Outlet_Sales, pred_log))
print("MAE of Sqrt")
(MAE(splitted_test$Item_Outlet_Sales, pred_sqrt))

print("RMSE pf Simple")
RMSE <- function(actual, predicted)  {sqrt(mean((actual - predicted)^2))}
print("RMSE pf Simple")
(RMSE(splitted_test$Item_Outlet_Sales, pred_simple))
print("RMSE pf Log")
(RMSE(splitted_test$Item_Outlet_Sales, pred_log))
print("RMSE pf Sqrt")
(RMSE(splitted_test$Item_Outlet_Sales, pred_sqrt))
