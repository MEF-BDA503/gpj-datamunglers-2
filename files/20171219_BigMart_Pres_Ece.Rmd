...
p0 <- qplot(x = Outlet_Identifier, y = sqrt(Item_Outlet_Sales), 
      color = Outlet_Type,
...
```{r, warning = FALSE } 
library(knitr)
include_graphics("/Users/yetkineser/Desktop/mae.png")

include_graphics("/Users/yetkineser/Desktop/rmse.png")
...
```{r,out.width = "700px", warning = FALSE } 
